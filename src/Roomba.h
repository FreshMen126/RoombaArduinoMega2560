...
#define Song_Start Roomba_Play_Song(0)      //мелодия старта
#define Song_Good Roomba_Play_Song(1)       //мелодия хорошо
#define Song_Bad Roomba_Play_Song(2)        //мелодия плохо
#define Song_Sleep Roomba_Play_Song(3)      //мелодия сна
